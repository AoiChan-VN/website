...
export const Header = () => {
    ...
    <div id="settings-modal" class="modal-overlay" style="display:none;">
        <div class="card settings-content">
            <h3>⚙️ Cấu Hình Giao Diện</h3>
            <div class="setting-item">
                <span>Chế độ hiển thị</span>
                <button onclick="window.toggleTheme()" class="btn-theme-toggle">🌓 Thay đổi Theme</button>
            </div>
            <div class="setting-item">
                <span>Ngôn ngữ</span>
            ...
            <button onclick="window.closeSettings()" class="btn-primary" style="background:#ff4444;">Đóng cài đặt</button>
        </div>
    </div>`;
};
